...
public class Component {
	...
	private String city_nameurbanization;
	...
	public String getCity_nameurbanization() {
		return city_nameurbanization;
	}
	public void setCity_nameurbanization(String city_nameurbanization) {
		this.city_nameurbanization = city_nameurbanization;
	}
	...
	public String toString() {
		return "Component [urbanization=" + urbanization + ", primary_number=" + primary_number + ", street_name="
				+ street_name + ", street_predirection=" + street_predirection + ", street_postdirection="
				+ street_postdirection + ", street_suffix=" + street_suffix + ", secondary_number=" + secondary_number
				+ ", secondary_designator=" + secondary_designator + ", extra_secondary_number="
				+ extra_secondary_number + ", extra_secondary_designator=" + extra_secondary_designator
				+ ", pmb_designator=" + pmb_designator + ", pmb_number=" + pmb_number + ", city_nameurbanization="
				+ city_nameurbanization + ", city_name=" + city_name + ", default_city_name=" + default_city_name
				+ ", state_abbreviation=" + state_abbreviation + ", zipcode=" + zipcode + ", plus4_code=" + plus4_code
				+ ", delivery_point=" + delivery_point + ", delivery_point_check_digit=" + delivery_point_check_digit
				+ "]";
	}
